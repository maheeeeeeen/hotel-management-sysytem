...
export default function ViewBooking() {
  ...
  const { room, checkInDate, checkOutDate, totalAmount, status, guest } =
    booking;

  return (
    <div className="w-full mx-auto  p-8 bg-linear-to-br from-white to-gray-50 rounded-2xl shadow-xl space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          {/* Meal Plan */}
          {room.mealPlan && (
            <div className="bg-linear-to-r from-amber-50 to-orange-50 p-6 rounded-xl border border-amber-100">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">
                    {room.mealPlanDescription || room.mealPlan}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-linear-to-r from-blue-500 to-teal-600 p-6 rounded-xl text-white">
